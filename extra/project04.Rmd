...
2. A presentation based on your slide show. This should be 10-15 minutes in
length (can be slightly shorter if you are a group of one person).
...
The set of documents you create is completely up to your group. You may, for
...
**Note**: You may decide for this project that you want to work alone. Please
let me know if you choose to split into two sub-groups.
