...
This is not nearly as good as the global model. We will see that when we have
a larger set of classes the model starts to become more competitive with the
global model.

By default, the function uses k equal to 1. We can manually set a different k
by setting the argument `k` in the function call.
